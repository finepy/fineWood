...
class UpdateProfileForm(forms.ModelForm):
    ...
    business_description = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'rows': 5}))
    ...
    class Meta:
        model = Vendor
        fields = {'profile_picture','business_name','business_description', 'country','cover','phone'}
